...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.radioButton_3, QtCore.SIGNAL(_fromUtf8("clicked()")), self.show_bar)
        QtCore.QObject.connect(self.radioButton_4, QtCore.SIGNAL(_fromUtf8("clicked()")), self.show_pie)
    ...
    def show_bar(self):
        sender = self.radioButton_3.sender() #获取信号
        In.drawResults()
        png = QtGui.QPixmap('bar.png').scaled(self.figLabel.width(), self.figLabel.height())
        self.figLabel.setPixmap(png)

    def show_pie(self):
        sender = self.radioButton_4.sender()  # 获取信号
        In.drawResults()
